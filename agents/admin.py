...
from .models import Bank, Agent, PropertySale, Commission
...
class CommissionAdmin(admin.ModelAdmin):
    list_display = ['agent', 'sale', 'commission_amount', 'commission_rate', 'status', 'created_at']
    list_filter = ['status', 'created_at', 'approved_at', 'paid_at']
    search_fields = ['agent__user__username', 'agent__user__email', 'sale__property__title']
